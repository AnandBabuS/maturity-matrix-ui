...
var Link = function Link(props) {
    return _react2.default.createElement(
        'a',
        { className: props.className, href: props.next },
        props.children
    );
};
